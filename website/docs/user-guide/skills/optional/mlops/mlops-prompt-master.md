---
title: "Prompt Master — Writes tool-specific prompts for LLM, image, and video AI"
sidebar_label: "Prompt Master"
description: "Writes tool-specific prompts for LLM, image, and video AI"
---
...
Writes tool-specific prompts for LLM, image, and video AI.

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `hermes skills install official/mlops/prompt-master` |
| Path | `optional-skills/mlops/prompt-master` |
| Version | `1.8.0` |
| Author | Nidhin Joseph Nelson (nidhinjs), Hermes Agent |
| License | MIT |
| Platforms | linux, macos, windows |
| Tags | `Prompts`, `Prompt Engineering`, `LLM`, `Image AI`, `Video AI` |
| Related skills | [`creative-ideation`](/docs/user-guide/skills/optional/creative/creative-creative-ideation) |
...
Turns a rough idea into one production-ready prompt aimed at a specific AI
tool. It does not write the deliverable itself, does not teach prompting
theory unless asked, and has no dependencies beyond this directory.

Vendored from [nidhinjs/prompt-master](https://github.com/nidhinjs/prompt-master)
v1.8.0 under the MIT license (see `LICENSE` in this directory). The body below
is upstream content; only the frontmatter and this header are Hermes-specific.
Reference material lives in `references/patterns.md` and
...
Identify the tool and route accordingly. Read full templates from [references/templates.md](https://github.com/NousResearch/hermes-agent/blob/main/optional-skills/mlops/prompt-master/references/templates.md) only for the category you need.
...
| File | Read When |
|------|-----------|
| [references/templates.md](https://github.com/NousResearch/hermes-agent/blob/main/optional-skills/mlops/prompt-master/references/templates.md) | You need the full template structure for any tool category |
| [references/patterns.md](https://github.com/NousResearch/hermes-agent/blob/main/optional-skills/mlops/prompt-master/references/patterns.md) | User pastes a bad prompt to fix, or you need the complete 37-pattern reference |
